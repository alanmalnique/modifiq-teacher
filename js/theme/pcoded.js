...
$(document).ready(function() {
    ...
    $("document,body").on('click', '.to-do-list input[type=checkbox]', function() {
    ...
    $("document,body").on('click', ".mob-toggler", function() {
    ...
    // close card
    $("document,body").on('click', ".card-option .close-card", function() {
        var $this = $(this);
    ...
    // reload card
    $("document,body").on('click', ".card-option .reload-card", function() {
        var $this = $(this);
    ...
    $("document,body").on('click', ".card-option .minimize-card", function() {
        var $this = $(this);
    ...
    // full card
    $("document,body").on('click', ".card-option .full-card", function() {
        var $this = $(this);
        var port = $($this.parents('.card'));
    ...
    $("document,body").on('click', '.event-btn', function() {
        var $port = $(this);
    ...
    var PcodedMenu = {
        ...
        HandleSubMenuTrigger: function() {
                ...
                if ((newSize >= 992 && $('body').hasClass('layout-6') || (newSize >= 992 && $('body').hasClass('layout-7')))) {
                    ...
                    if ($('body').hasClass('layout-6') || $('body').hasClass('layout-7')) {
                        ...
                        if (!$('.pcoded-navbar').hasClass('theme-horizontal-dis')) {
                            ...
                            $dropdown.off('mouseenter mouseleave').off('click');
                            $("document,body").on('click', ".pcoded-navbar:not(.theme-horizontal-dis) .pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li",
                                function() {
                            ...
                            $("document,body").on('click', ".pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li", function(e) {
                                e.stopPropagation();
                                var str = $(this).closest('.pcoded-submenu').length;
                                if (str === 0) {
                                    if ($(this).hasClass('pcoded-trigger')) {
                        ...
                        if (newSize >= 992) {
                            ...
                            $dropdown.off('mouseenter mouseleave').off('click');
                            $("document,body").on('click', ".pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li",
                                function() {
                                    var str = $(this).closest('.pcoded-submenu').length;
                                    if (str === 0) {
                                        if ($(this).hasClass('pcoded-trigger')) {
            ...
            switch (settings.SubMenuTrigger) {
                case 'click':
                    ...
                    $("document,body").on('click', ".pcoded-submenu > li", function(e) {
                        e.stopPropagation();
                        var str = $(this).closest('.pcoded-submenu').length;
                        if (str === 0) {
                            if ($(this).hasClass('pcoded-trigger')) {
        ...
        HandleMenuTrigger: function() {
            ...
            if (newSize >= 992) {
                    ...
                    if ((newSize >= 768 && $('body').hasClass('layout-6') || (newSize >= 768 && $('body').hasClass('layout-7')))) {
                        ...
                        if ($('body').hasClass('layout-6') || $('body').hasClass('layout-7')) {
                            ...
                            if (!$('.pcoded-navbar').hasClass('theme-horizontal-dis')) {
                                ...
                                $dropdown.off('mouseenter mouseleave').off('click');
                                $("document,body").on('click', ".pcoded-navbar:not(.theme-horizontal-dis) .pcoded-inner-navbar > li",
                                    function() {
                                        if ($(this).hasClass('pcoded-trigger')) {
                                            $(this).removeClass('pcoded-trigger');
                                            $(this).children('.pcoded-submenu').slideUp();
                ...
                var $dropdown = $(".pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar > li");
                $dropdown.off('mouseenter mouseleave').off('click');
                $("document,body").on('click', ".pcoded-navbar.theme-horizontal-dis .pcoded-inner-navbar > li",
                    function() {
                        if ($(this).hasClass('pcoded-trigger')) {
                            $(this).removeClass('pcoded-trigger');
                            $(this).children('.pcoded-submenu').slideUp();
            ...
            switch (settings.MenuTrigger) {
                case 'click':
                    ...
                    $("document,body").on('click', ".pcoded-inner-navbar > li:not(.pcoded-menu-caption) ", function() {
                        if ($(this).hasClass('pcoded-trigger')) {
                            $(this).removeClass('pcoded-trigger');
                            $(this).children('.pcoded-submenu').slideUp();
                        } else {
            ...
            switch (settings.themelayout) {
                case 'horizontal':
                    ...
                    if (trigger === "hover") {
                        ...
                        $("document,body").on('click', "li.pcoded-hasmenu", function(e) {
                            e.preventDefault();
                            if ($('.pcoded-submenu', this).length) {
                                var elm = $('.pcoded-submenu:first', this);
                                var off = elm.offset();
...
$(window).ready(function() {
    var vw = $(window)[0].innerWidth;
    $("document,body").on('click tap', ".pcoded-navbar", function(e) {
        e.stopPropagation();
    });
    $("document,body").on("click", '.pcoded-main-container,.pcoded-header', function() {
        if (vw < 992) {
    ...
    $("document,body").on('click', '.pcoded-navbar .close', function() {
        var port = $(this);
        port.parents('.card').fadeOut('slow').remove();
    });
    $("document,body").on('click', '#more-details', function() {
        console.log('a');
